...
const Navbar = () => {
  ...
  return (
    <div
      className={`lg:fixed sticky w-full top-0 z-50 ${
        isVisible ? "top-0" : "-top-[75px]"
      } ${
        isTransparent ? "lg:bg-transparent" : "lg:bg-white"
      } bg-gray-900 transition-all duration-500 border-b-[1px] border-[#bbbbbb42]`}
    >
        ...
        <div className="container mx-auto flex flex-wrap px-5 py-3 items-center justify-between">
          ...
          >
            <Link
              ...
              } xl:mr-5 px-3 py-2 rounded transition-all duration-300`}
              data-aos="fade-up"
            >
              Home
            </Link>
