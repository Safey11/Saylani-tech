    ...
    <section className="text-gray-600 body-font relative bg-gradient-to-b from-indigo-100 via-white to-indigo-50 ">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          <h1 className="sm:text-4xl text-3xl font-bold title-font mb-4 text-indigo-900 drop-shadow-lg">
            For Contact Get Your Ticket
          </h1>
          <p className="lg:w-2/3 mx-auto leading-relaxed text-2xl text-gray-600 font-light">
            Reserve your spot for an unforgettable experience! Just fill out the
            form below and get instant confirmation.
          </p>
        </div>
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <form
            onSubmit={getticket}
            className="flex flex-wrap -m-2 bg-white rounded-lg p-10 shadow-xl border border-gray-100 transition-all hover:shadow-2xl hover:scale-105 duration-300 ease-in-out"
          >
            <div className="p-2 w-full">
              <div className="relative">
                ...
                <input
                  ...
                  } focus:border-indigo-600 focus:bg-white focus:ring-2 focus:ring-indigo-300 text-base outline-none text-gray-700 py-3 px-4 leading-8 transition-colors duration-300 ease-in-out`}
                  value={formData.name}
          ...
          <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
            <span className="text-indigo-500 hover:text-purple-600">
              support@Smit.com
            </span>
          </div>
        </div>
