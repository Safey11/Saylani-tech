...
// Team members array
const teamMembers = [
  { id: 1, name: 'Aliyan Sheikh', position: 'Project Manager', description: 'Expert in full-stack development', image: Aliyan },
  { id: 2, name: 'Zeshan Ajjaz', position: 'lead mannager', description: 'Specialized in Node.js and databases', image: zeeshan },
  { id: 3, name: 'Wajid Ahmed', position: 'UI/UX Designer', description: 'Creating user-friendly designs', image: wajid},
