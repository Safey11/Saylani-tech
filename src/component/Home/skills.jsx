...
const workItems = [
  ...
  },
  {
    ...
    imageUrl:
      "https://segwitz.com/wp-content/uploads/2023/09/5757453-scaled-1.jpg",
  },
  {
    id: 4,
...
const WhatWeWorkOn = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#4d193d] via--[#9f6e8f] to-[#4d193d] py-20">
      <h2
        className="text-5xl font-extrabold text-center mb-12 text-transparent bg-clip-text text-white"
        data-aos="fade-up"
      >
        What We Work On
      </h2>
            ...
            >
              <div className="relative bg-white rounded-xl shadow-lg overflow-hidden h-full flex flex-col justify-between transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl">
                ...
                <div className="p-6 flex-grow">
                  <h3 className="text-xl font-semibold text-[#ce474c]">
                    {item.title}
                  </h3>
