  ...
  const getAllServices = async () => {
    try {
      const response = await fetch(
        "https://saylani-tech-backend.vercel.app/services/",
        {
          method: "GET",
        }
      );
    ...
    <section className="bg-purple-900 py-24">
      <div className="container px-5 mx-auto">
        <div className="flex flex-col text-center mb-20">
          <h1 className="text-6xl font-extrabold mb-12 text-white bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 animate-text">
            OUR Services
          </h1>
          <p className="lg:w-2/3 mx-auto leading-relaxed text-lg text-white bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
            Crafting modern solutions to fuel your digital transformation
            journey.
          </p>
        </div>
