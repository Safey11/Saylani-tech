...
const ServicesBar = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-red via-indigo-900 to-red min-h-screen flex items-center justify-center">
      {" "}
      ...
      <section className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        >
          ...
          <p className="mb-8 leading-relaxed text-red-700">
            ...
            delivering high-quality, efficient, and scalable solutions to meet
            your business needs.
          </p>
