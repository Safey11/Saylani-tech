      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-10">
        ...
        <div className="mb-10" data-aos="fade-right">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            Illustrations are more than just visuals—they bring stories, ideas,
            and concepts to life. Whether you’re looking to enhance your
            website, product, or marketing materials, our custom illustration
            design services help make your brand stand out with unique, creative
        ...
        <div className="mb-10" data-aos="fade-left">
          ...
          <ul className="list-disc list-inside text-lg text-gray-700 space-y-4">
            <li>
              Custom illustrations tailored to your brand's identity and message
            </li>
        ...
        <div className="mb-10" data-aos="fade-right">
          ...
          <ol className="list-decimal list-inside text-lg text-gray-700 space-y-4">
            <li>
              Initial Consultation: Understand your brand, audience, and vision
            </li>
            <li>
              Concept Development: Sketch ideas and concepts based on your input
            </li>
            <li>
              Design Execution: Create digital illustrations in various styles
            </li>
            <li>
              Feedback & Revisions: Refine the artwork according to your
              feedback
            </li>
            <li>
              Delivery: Provide final illustrations in multiple formats (PNG,
              SVG, etc.)
            </li>
          </ol>
        </div>
        ...
        <div className="text-center mt-10" data-aos="zoom-in">
          <button className="bg-[#ce474c] text-white text-lg font-semibold py-3 px-6 rounded-lg hover:bg-indigo-700 transition duration-300">
