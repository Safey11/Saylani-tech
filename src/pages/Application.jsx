    ...
    <div className="min-h-screen bg-black py-20">
      ...
      <div className="container mx-auto text-center" data-aos="fade-down">
        ...
        <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-8">
          Building high-quality, scalable, and efficient applications for all
          platforms.
        </p>
      </div>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-5 md:px-0">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            Our application development services are designed to provide
            customized solutions tailored to your business needs. We create
            fast, secure, and scalable applications that can support your
            company’s growth.
          </p>
        ...
        <div className="p-6 bg-white rounded-lg shadow-lg" data-aos="fade-left">
          ...
          <p className="text-gray-600 text-lg">
            ...
            your application is robust and future-proof. Here are some
      ...
      <div className="container mx-auto text-center mt-10" data-aos="zoom-in">
        <button className="bg-red-900 text-white py-3 px-6 rounded-lg hover:bg-black transition duration-300">
          Get in Touch
        </button>
      </div>
    </div>
