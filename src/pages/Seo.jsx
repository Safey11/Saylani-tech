  ...
  return (
    <div className="bg-gray-100 min-h-screen py-10">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-10">
        {/* Header */}
        <h1
          className="text-5xl font-bold text-center text-indigo-600 mb-8"
          data-aos="fade-up"
        >
        ...
        <div className="mb-10" data-aos="fade-right">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            Search Engine Optimization (SEO) is key to improving your website’s
            visibility on search engines like Google. With our expert SEO
            services, we help your business rank higher, drive more traffic, and
            ultimately increase your online presence. We use proven strategies
            that align with search engine algorithms and provide long-lasting
            results.
          </p>
        </div>
        ...
        <div className="mb-10" data-aos="fade-right">
          ...
          <ol className="list-decimal list-inside text-lg text-gray-700 space-y-4">
            <li>
              Initial Consultation: Understand your business goals and current
              SEO standing
            </li>
            <li>
              Comprehensive Website Audit: Identify SEO opportunities and areas
              for improvement
            </li>
            <li>
              Keyword Research: Find relevant, high-traffic keywords for your
              business
            </li>
            <li>
              On-Page & Off-Page Optimization: Improve your website structure,
              content, and build backlinks
            </li>
            <li>
              Performance Tracking: Regularly monitor SEO performance and make
              adjustments
            </li>
          </ol>
        </div>
